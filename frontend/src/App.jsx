...
const Homepage = lazy(() => import("./components/Home"));
const Dashboard = lazy(() => import("./components/Shared/Dashboard"));
const UserReport = lazy(() => import("./components/User/Report"));  // Make sure this path is correct
const AdminReport = lazy(() => import("./components/Admin/AdminReport")); // Make sure this path is correct
const Transactions = lazy(() => import('./components/Shared/Transactions'));
const Users = lazy(() => import('./components/Shared/Users'));
